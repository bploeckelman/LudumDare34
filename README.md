...
[![Travis build status](https://travis-ci.org/bploeckelman/LudumDare34.svg)](https://travis-ci.org/bploeckelman/LudumDare34)

## Build Requirements

* [JDK](http://www.oracle.com/technetwork/java/javase/downloads/jdk8-downloads-2134151.html)
...
If you need to install `git` and clone the project, do that first:
    ...
    brew install git
    mkdir ~/code && cd ~/code
    git clone git@github.com:bploeckelman/LudumDare34.git
    cd LudumDare34
